...
def run():
    ...
    timeline_data = {
        ...
        "events": [
            {"start_date": {"year": "2018", "month": "08"}, "end_date": {"year": "2022", "month": "06"}, "text": {"headline": "BTech - Automobile Engineering, MIT Manipal"}},
            {"start_date": {"year": "2019", "month": "03"}, "end_date": {"year": "2021", "month": "05"}, "text": {"headline": "Research Project - LoopMIT, Dept Head"}},
            ...
            {"start_date": {"year": "2023", "month": "09"}, "end_date": {"year": "2024", "month": "12"}, "text": {"headline": "MS in Business Analytics - Northeastern"}},
            {"start_date": {"year": "2024", "month": "01"}, "text": {"headline": "Business Analyst - Radiant Consulting"}},
            {"start_date": {"year": "2024", "month": "04"}, "text": {"headline": "Mentor & Teacher - TSNE Pathway / Dudley St Charter School"}},
